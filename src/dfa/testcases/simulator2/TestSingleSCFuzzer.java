...
public class TestSingleSCFuzzer {
  ...
  //	makeTestCase("data/uwfms/EmergencyVehicleAvoidance.stb", new String[] {"A"}, new String[]{"Fail", "Fail"});
  		//makeTestCase("data/uwfms/eva_speedctrl.stb", new String[] {"A"}, new String[]{"Fail", "Fail"});
  		//makeTestCase("data/uwfms/caeva.stb", new String[] {"A"}, new String[]{"sense","Disengaged","Disengaged1"});
		  makeTestCase("data/uwfms/capa.stb", new String[] {"A"}, new String[]{"sense","caDisabled","paDisabled"});
