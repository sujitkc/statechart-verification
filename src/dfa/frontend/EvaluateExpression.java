    ...
    public static Expression evaluate(Expression e){
        try {
          if(e instanceof BinaryExpression)
            ...
            return FrontEnd.eState.getValue(((Name)e).getDeclaration());
